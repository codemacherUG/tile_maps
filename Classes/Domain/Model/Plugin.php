...
class Plugin
{
     ...
     * @var string
     */
    protected string $iconFileName = "GenericContentElement.svg";

    /**
     * @var string
     */
    protected string $wizardGroupId = "common";

    /**
     * @var bool
     */
    protected bool $enableFlexFrom = false;
    ...
    {
        if($this->enableFlexFrom) {
            return true;
        }
        if(in_array("pi_flexform", $this->showItemsGeneralOptions)) {
            return true;
        }
        return false;
    }
